...
1>Responsive Units:  make sure  website is accessible is to use responsive units, example, use REM, EM, %.
2>Screen Readers: it is important to make sure that tags are semantic.
3>Color: every colorfully displayed component should have a visual counterpart. 
