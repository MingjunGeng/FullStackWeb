...
module.exports = {
  ...
  "_spec": "axios",
  "_where": "/Users/raylea/Dropbox/Workspace/github/LambdaAssignments/github-usercard",
  "author": {
    "name": "Matt Zabriskie"
  },
  "browser": {
...
function cardMaker(userData) {
  ...
  var usersLocation = document.createElement('p');
  var profile = document.createElement('p');
  var address = document.createElement('a');
  var followers = document.createElement('p');
  var following = document.createElement('p');
  var bio = document.createElement('p'); // Append Element
  ...
  cardInfo.appendChild(bio); // Add Class
  ...
  following.textContent = "".concat(userData.following, " ");
  return card;
...
function showUserCard(URL) {
  _axios.default.get(URL).then(function (resp) {
    ...
    var card = cardMaker(resp.data); // STEP 4:     
...
var myURL = 'https://api.github.com/users/sooof';
showUserCard(myURL); // STEP 5: 

var friendsArray = ['tetondan', 'dustinmyers', 'justsml', 'luishrd', 'bigknell'];
friendsArray.forEach(function (element) {
  var url = "https://api.github.com/users/".concat(element);
  showUserCard(url);
}); // friendsArray.forEach(function(element){
