...
// Your code goes here
var bodyL = document.querySelector('body'); // bodyL.style.backgroundColor = 'grey';

var navA = document.querySelectorAll('nav a');
var navContaine = document.querySelector('.nav-container'); // mouseover
...
var navContact = document.querySelector('.contact'); // click
...
navContact.addEventListener('click', clickNav); // keydown f5 reload
...
document.addEventListener('keydown', reLoad); // wheel

function wheelEvent(event) {
  bodyL.style.backgroundColor = '#CCFFFF';
}

bodyL.addEventListener('wheel', wheelEvent); // disappear modal
...
fileInput.addEventListener('change', handleSelected); // resize

function myFunction() {
  var w = window.outerWidth;
  var h = window.outerHeight;
  var txt = "Windows size: Width=" + w + ", Height=" + h; //document.getElementById("demo").innerHTML=txt;

  console.log(txt);
}

addEventListener('resize', myFunction); // scroll
// select
// dblclick
// drag / drop
